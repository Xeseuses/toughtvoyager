...
Use the 90% rule. As you evaluate an option, give the option a score between 0 and 100. If you rate it any lower than 90, change the rating to 0 and simply reject it. 

The point is that the very act of applying selective criteria forces you to choose which perfect option to wait for.

If we say yes because it is an easy reward, we run the risk of having later to say no to a more meaningful one.

How to make a selection?
1. Write down the opportunity
2. Write down a list of three minimum criteria
3. Write down a list of three extreme criteria
4. Check if it passes the first set of criteria
5. If yes, check if it passes two of the extreme critera
6. 4 and 5 yes? Taken. No? Reject
...
The reality is that either we can say no and regret it for a few minutes, or we can say no and regret it for a few minutes, or we can say yes and regret it for days, weeks, months or even years!

# Uncommit
Beware of the sunk-cost bias. That is the tendency to continue to invest time, money or energy into something we know is a losing proposition simply because we have sunk a cost that can't be recouped.

Beware of the Endowment Effect. That is our tendency to undervalue things that aren't ours and to overvalue thing, because we already own them.

When we get so emotionally hung up trying to force something that is not the right bit, we can often benefit from a sounding board.
...
Remember: Their problem is not your problem!
...
Make a list of your dealbreakers with requests or activities you simply refuse to say yes to unless they overlap with your own priorities or agenda. Or another quick test is to write down things that makes you feel even a twinge of resentment even if it is a small pinch. It is a clue for discovering your own hidden boundaries.
...
The question is this: What is the "slowest hiker" in your life? Then focus on these constrains or obstacles and remove them. Use the steps:
...
Be in the now. Ask yourself what is most important this very second. If you're not sure, make a list of everything vying for your attention and cross off anything that is not important right now.
...
Which are you at your core: non-Essentialist or Essentialist?
